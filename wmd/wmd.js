...
Attacklab.wmdBase = function(){
	...
	//var siteURL = "http://slickcms.slickhouse.com/"
	var siteURL = "http://slickcms/"
	
	// The text that appears on the upper part of the dialog box when
	// entering links.
	var imageDialogText = "<p style='margin-top: 0px'><b>Enter the image URL.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>Example:<br />" + siteURL + "images/cloud1.jpg   \"Optional title\"</p>";
	var linkDialogText = "<p style='margin-top: 0px'><b>Enter the web address.</b></p><p>You can also add a title, which will be displayed as a tool tip.</p><p>Example:<br />" + siteURL + "   \"Optional title\"</p>";
	...
	var helpLink = "http://support.slickhouse.com/";
	var helpHoverTitle = "Slickhouse Support";
